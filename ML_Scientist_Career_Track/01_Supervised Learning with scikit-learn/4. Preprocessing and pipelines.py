...
df = pd.read_csv('/Online course/datacamp/01_Supervised Learning with scikit-learn/data/auto.csv')
...
# Exercise 1
df = pd.read_csv('/Online course/datacamp/01_Supervised Learning with scikit-learn/'
