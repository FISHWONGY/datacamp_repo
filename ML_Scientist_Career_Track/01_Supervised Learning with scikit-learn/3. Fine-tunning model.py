...
df = pd.read_csv('/Online course/datacamp/01_Supervised Learning with scikit-learn/data/house-votes-84.csv')
...
# EXERCISE 1
df = pd.read_csv('/Online course/datacamp/01_Supervised Learning with scikit-learn/data/diabetes.csv')
